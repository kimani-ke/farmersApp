...
import com.example.maryanneapplication.models.Product
...
class ProductRepository(var navController: NavHostController, var context: Context) {
    ...
    fun saveProductWithImage(productName:String, productQuantity:String, productPrice:String,productDescription:String, filePath: Uri){
        var id = System.currentTimeMillis().toString()
            ...
            if (it.isSuccessful){
                ...
                storageReference.downloadUrl.addOnSuccessListener {
                    ...
                    var houseData = Upload(productName,productQuantity,
                        productPrice, productDescription,imageUrl,id)
