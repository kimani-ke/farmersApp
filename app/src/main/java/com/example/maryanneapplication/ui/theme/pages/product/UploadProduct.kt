...
@Composable
fun UploadItem(name:String, quantity:String, price:String, imageUrl:String,desc:String, id:String,
...
@Preview
@Composable
fun UploadProductPreview() {
    MaryanneApplicationTheme {
        UploadProduct(rememberNavController())
    }
